<?php 
    ...
    foreach($nivel as $nivel) : 
        $nivel_procedimento = $nivel["analise"];
    endforeach; 
?>
...
<div class="col-md-12">
    <div class="card">
        <div class="header">
            <h4 class="title">Analises de Risco</h4>
        </div>
        <div class="content table-responsive table-full-width">
            <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><?= anchor("analises/{$produto['id']}", $produto["nome"]); ?></td>
                            <td><?= character_limiter($produto["data"], 10) ?></td>
                            <td><?= anchor("analises/{$produto['id']}", "Imprimir / Visualizar"); ?></td>
                            <td><?= anchor("analises/excluir/{$produto['id']}", "Excluir"); ?></td>
                        </tr>
                        <?php endforeach ?>
                    </tbody>
                </table>
        ...
        <?= anchor('analises/formulario','Adicionar Nova Análise de Risco', array("class" => "btn btn-success"))?>
