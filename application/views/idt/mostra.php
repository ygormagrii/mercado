...
<?= anchor('idt/','< VOLTAR', array("class" => "btn btn-primary no-print"))?> &nbsp;
<a href="javascript:print();" class="btn btn-success no-print">Imprimir / Baixar PDF</a>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
<!-- saved from url=(0085)http://www.htmlpublish.com/newTestDocStorage/DocStorage/1908540186/bcl_1908540186.htm -->
...
<div class="dclr"></div>
<div id="id_1">
<p class="p0 ft0" style="margin-left: 8.4%;"><nobr><?=$produto["nome"]?></nobr></p>
</div>
<div id="id_2">
<div id="id_2_1">
...
<p class="p3 ft6"><span class="ft4" style="color: black;position: relative;top: 15px;left: -4px;"><?=$produto["pontos_bloqueio"]?></span><span class="ft5">Pontos de Bloqueio</span></p>
</div>
<div id="id_2_2">
...
<p class="p5 ft11"><span class="ft10">Nota: </span>Todos os disjuntores devem ser bloqueados com dispositivos específicos + cadeado plástico colorido + etiqueta de identificação junto ao cadeado com o nome do colaborador.</p>
</div>
</div>
<div id="id_3">
<table id="example" class="table table-striped table-bordered" style="width:100%;border: 4px solid #000;">
    <thead>
    	<tr>    		
    	</tr>
    	<tr height="30"></tr>
    ...
    <tbody>
	    ...
	    <tr>
       	...
       	<tr>
			<td><input name="fname[]" value="<?=$fname_array[24]?>" type="text" readonly="true"></td>
			...
			<td><input name="fname[]" value="<?=$fname_array[27]?>" type="text" readonly="true"></td>
		...
		<tr>	
			...
			<td><input name="fname[]" value="<?=$fname_array[30]?>" type="text" readonly="true"></td>
		...
		<tr>	
			...
			<td><input name="fname[]" value="<?=$fname_array[33]?>" type="text" readonly="true"></td>
	    ...
	    <tr>
			<td><input name="fname[]" value="<?=$fname_array[36]?>" type="text" readonly="true"></td>
			...
			<td><input name="fname[]" value="<?=$fname_array[39]?>" type="text" readonly="true"></td>
	    </tr>
	    <tr>
